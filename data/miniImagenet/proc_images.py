...
path_to_images = '/home/huaxiuyao/Data/miniimagenet/images/'
...
for datatype in ['train', 'val', 'test']:
    os.system('mkdir ' +'/home/huaxiuyao/Data/miniimagenet/'+datatype)

    with open('/home/huaxiuyao/Data/miniimagenet/'+datatype + '.csv', 'r') as f:
        ...
        for i, row in enumerate(reader):
            ...
            image_name = row[0]
            if label != last_label:
                cur_dir = '/home/huaxiuyao/Data/miniimagenet/' + datatype + '/' + label + '/'
                os.system('mkdir ' + cur_dir)
                last_label = label
            os.system('mv /home/huaxiuyao/Data/miniimagenet/images/' + image_name + ' ' + cur_dir)
